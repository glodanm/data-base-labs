...
-- INSERT `exercise`
-- -----------------------------------------------------
INSERT INTO `lab_1`.`exercise` (`id`, `burning calories`, `time_of_set`, `training_type_id`, `fitness_machine_id`)
VALUES ('1', '50', '30', '1', '1');
...
INSERT INTO `lab_1`.`training_type` (`id`, `type`, `number_of_sets`, `numbers_of_daysclient`)
